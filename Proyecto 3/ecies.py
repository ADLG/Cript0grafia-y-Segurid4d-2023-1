...
def ecies():
    ...
    potY = 2
    a = 48666
    b = random.randint(1, 11241240)
    mod = 11
    remitenteKey = random.randint(1, 32432)#int(input("Ingrese la clave del remitente:"))
    destinatariokey = random.randint(1, 12421)#int(input("Ingrese la clave del destinatario:"))
    print(remitenteKey)
    print(destinatariokey)
    puntoX = 1
    puntoY = 1
    msg = 1
    print(msg)
